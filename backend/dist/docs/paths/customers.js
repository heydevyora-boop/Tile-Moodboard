...
exports.customerPaths = {
    '/customers': {
        get: {
            ...
            responses: { 200: { description: 'A page of customers.', content: { 'application/json': { schema: customerListResponse } } }, ...(0, responses_1.standardErrors)() },
        },
        post: {
            tags: ['Customers'],
            ...
            responses: { 201: { description: 'Created.', content: { 'application/json': { schema: customerResponse } } }, ...(0, responses_1.standardErrors)(422) },
        },
    },
    '/customers/{id}': {
        get: {
            ...
            responses: { 200: { description: 'The customer.', content: { 'application/json': { schema: customerResponse } } }, ...(0, responses_1.standardErrors)(404) },
        },
        patch: {
            tags: ['Customers'],
            ...
            responses: { 200: { description: 'Updated.', content: { 'application/json': { schema: customerResponse } } }, ...(0, responses_1.standardErrors)(404, 422) },
        },
        delete: {
            tags: ['Customers'],
            ...
            security: [{ bearerAuth: [] }],
            parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string' } }],
            responses: { 200: { description: 'Deleted.' }, ...(0, responses_1.standardErrors)(404) },
        },
    },
    '/customers/{id}/history': {
        get: {
            ...
            responses: {
                ...
                ...(0, responses_1.standardErrors)(404),
            },
        },
    },
    '/customers/{id}/favorites': {
        ...
        post: {
            ...
            responses: {
                ...
                ...(0, responses_1.standardErrors)(404, 409),
            },
        },
    },
    '/customers/{id}/favorites/{tileId}': {
        delete: {
            ...
            responses: { 200: { description: 'Removed.' }, ...(0, responses_1.standardErrors)(404) },
        },
    },
};
