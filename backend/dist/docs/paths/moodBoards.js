...
exports.moodBoardPaths = {
    '/mood-boards/generate': {
        post: {
            ...
            responses: {
                ...
                429: responses_1.errorResponses[429],
    ...
    '/mood-boards': {
        get: {
            ...
            responses: { 200: { description: 'A page of mood boards.', content: { 'application/json': { schema: { type: 'object', properties: { success: { type: 'boolean' }, data: { type: 'object', properties: { boards: { type: 'array', items: { $ref: '#/components/schemas/MoodBoard' } } } }, meta: { $ref: '#/components/schemas/PaginationMeta' } } } } } }, ...(0, responses_1.standardErrors)() },
        },
        post: {
            tags: ['Mood Boards'],
            ...
            responses: { 201: { description: 'Saved.', content: { 'application/json': { schema: moodBoardResponse } } }, ...(0, responses_1.standardErrors)(422) },
        },
    },
    '/mood-boards/{id}': {
        get: { tags: ['Mood Boards'], summary: 'Get a saved mood board', security: [{ bearerAuth: [] }], parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string' } }], responses: { 200: { description: 'The board.', content: { 'application/json': { schema: moodBoardResponse } } }, ...(0, responses_1.standardErrors)(404) } },
        patch: { tags: ['Mood Boards'], summary: 'Edit a saved mood board', security: [{ bearerAuth: [] }], parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string' } }], requestBody: { required: true, content: { 'application/json': { schema: { type: 'object' } } } }, responses: { 200: { description: 'Updated.', content: { 'application/json': { schema: moodBoardResponse } } }, ...(0, responses_1.standardErrors)(404, 422) } },
        delete: { tags: ['Mood Boards'], summary: 'Delete a saved mood board', security: [{ bearerAuth: [] }], parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string' } }], responses: { 200: { description: 'Deleted.' }, ...(0, responses_1.standardErrors)(404) } },
    },
    '/mood-boards/{id}/approve': {
        post: {
            ...
            responses: { 200: { description: 'Approved.', content: { 'application/json': { schema: moodBoardResponse } } }, ...(0, responses_1.standardErrors)(404, 422) },
        },
    },
};
//# sourceMappingURL=moodBoards.js.map