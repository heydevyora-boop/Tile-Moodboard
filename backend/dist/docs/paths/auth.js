...
exports.authPaths = {
    '/auth/login': {
        post: {
            ...
            responses: {
                ...
                401: responses_1.errorResponses[401],
    ...
    '/auth/logout': {
        post: {
            ...
            security: [{ bearerAuth: [] }],
            responses: { 200: { description: 'Logged out.' }, ...(0, responses_1.standardErrors)() },
        },
    },
    '/auth/me': {
        get: {
    ...
    '/auth/forgot-password': {
        post: {
            ...
            responses: { 200: { description: 'A reset email was sent if the account exists.' }, 429: responses_1.errorResponses[429] },
        },
    },
    '/auth/reset-password': {
        post: {
